...
event = '/Users/chengxin/Documents/Harvard/Julia/julia_noise_shared/data_test/noise_data/Event_2010_???'
        ...
        for jj in range (len(tdir)):
            ...
            for tfile in tfiles:
                ...
                if not os.path.isfile(fft_h5):                    
                    with h5py.File(fft_h5,"w") as ds:
                        print("creating new file",fft_h5)
                ...
                with h5py.File(fft_h5,"a") as fft_ds:
                    ...
                    print("writng dst:",path)
                    crap[:,:Nfft//2+1]=source_white[:,:Nfft//2+1]
